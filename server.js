...
//actual database table creation. Create table if not exist or empty
...
// Regular expression used to match input url
// You can also just use "/studentList/list", but either way the first slash is needed
app.get("/ant-better-post.glitch.me/display.html", handlePostcard); 
